...
#   Description:Here we train the model based of the input arguments 
#               provided by the user such as the path of directory where
#               the training images are located, the rate at which the model
#               is supposed to be trained, number of hidden units and whether
#               the user wants to train it on a CPU or a GPU(this one is faster).
#####################################################################################################
