...
#   Description:This code is related to a data pre-processing step in a deep learning project. 
#               The data, in this case images, is divided into sets such as training, testing, 
#               and validation. These sets are then transformed using the transforms method 
#               from torchvision, a popular computer vision library in Python. The transformed 
#               data is further grouped into batches of a single size using the Dataloader in 
#               torch.utils. The code contains a function which accepts the path of the parent 
#               directory as an argument and performs these operations on the data.
#####################################################################################################
